...
window.onload = function() {
 ...
 //core = new Game(320, 240);
  ...
  core.sparetime = 0;
  core.mode = 'pre';
  core.preload('image/person.png','image/stage.jpg','image/num.png','image/plate.png','image/GRAPPLE.png','image/gauge.png','image/world.png','image/iwa.png','image/slime.png','戦闘用BGM.wav','image/apple.png','image/IchigoBakuMajiro.png','image/steam.png','image/haguruma.png','image/ha.png','image/ha1.png','image/serect.png','image/old.png','image/gard.png','image/charge.png','image/energy.png','image/wanted.png','image/mugen.png','image/uzu.png');
